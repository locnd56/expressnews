...
DD_belatedPNG.fix('img, form#topSearch, button, #bottom-tile, .box1-top, .box1-bot, .box2 .post, .box2-top, .box2-bot, h3.title-featured, h3.title-recent, .Nav a, .Nav .on, .box2 .comment a, #categorybox, #bottom #recentcomments li, #bottom .subscribe form, #bottom .subscribe .rss, #main.single .box3-top, #main.single .box3-bot, #main.single .post, #main .advert_468x60, #comments ol.commentlist li');
