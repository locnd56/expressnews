...
<?php if ( have_comments() ) : ?>
	...
	<h3 class="comm"><?php comments_number('No Responses', 'One Response', '% Responses' );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
...
<p><textarea class="textarea" name="comment" id="comment" style="width:95%" rows="10" tabindex="4"></textarea></p>
...
<div class="fieldset">
	...
	<div class="field">
		...
		<textarea class="textarea" name="comment" id="comment" style="width:95%" rows="10" tabindex="4"></textarea>
