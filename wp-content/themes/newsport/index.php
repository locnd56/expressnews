<?php get_header(); ?>
        	...
        	<div id="content">
                ...
                <!-- MPU 300x300 ad -->
				<?php if (get_option('woo_ad_300') && !get_option('woo_ad_300_bot')) { if (get_option('woo_ad_300_adsense') <> "") echo stripslashes(get_option('woo_ad_250_adsense')); else { ?>
                ...
                <?php foreach ( $getcats as $cat ) { ?>		
                    ...
                    <div class="news">		
						...
						<?php woo_get_image('image','category'); ?> 
