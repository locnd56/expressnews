...
<body id="<?php if(is_home()) echo 'home'; else echo 'sub'; ?>" class="custom">
	...
	<div id="page">
        <div id="header">
            ...
            <div id="logo" <?php if (get_option('woo_ad_top') || (get_option('woo_logo_left'))) echo 'class="fl"'; ?>>
            ...
            <!-- Top Ad 468x60 -->
            <?php if (get_option('woo_ad_top')) { if (get_option('woo_ad_top_adsense') <> "") echo stripslashes(get_option('woo_ad_top_adsense')); else { ?>
            <div id="advert_top">
        ...
        <ul id="nav" class="sf-menu">
            ...
            <li style="float:right"><a href="<?php if ( get_option('woo_feedburner_url') <> "" ) echo get_option('woo_feedburner_url'); else echo get_bloginfo_rss('rss2_url'); ?>">RSS</a></li>
            <?php if (get_option('woo_feedburner_id')) : ?>
            <li style="float:right"><a href="http://feedburner.google.com/fb/a/mailverify?uri=<?php echo get_option('woo_feedburner_id'); ?>" target="_blank">Email</a></li>
            <?php endif; ?>
        </ul>
