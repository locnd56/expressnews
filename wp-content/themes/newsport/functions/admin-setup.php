...
if (!$width && !$height) {
	if ($type == "featured") {
		$width = "458"; $height = "230";
		// Get custom sizes from options panel
		if ( get_option('woo_feat_image_width') && get_option('woo_feat_image_height') ) {
			$width = get_option('woo_feat_image_width');
			$height = get_option('woo_feat_image_height');
		} 		
		...
		$width = "140"; $height = "90";
		// Get custom sizes from options panel
		if ( get_option('woo_archive_width') && get_option('woo_archive_height') ) {
			$width = get_option('woo_archive_width');
			$height = get_option('woo_archive_height');
		} 		
	} elseif ($type == "single") {
