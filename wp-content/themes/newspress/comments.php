...
<p style="padding:10px 0px 10px 0px;"><input name="submit" style="border:none !important;" type="image" src="<?php bloginfo('stylesheet_directory'); ?>/styles/<?php echo "$style_path"; ?>/btn-submit.gif" id="submit" tabindex="5" value="Submit Comment" />
