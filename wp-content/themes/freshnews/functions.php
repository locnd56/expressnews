...
$options = array (
				...
				array(	"name" => "I want a blog!",
						"desc" => "Check this box if you'd like your homepage to look like a blog. When checked, the homepage won't show the featured section anymore and will replace it a traditional blog layout..",
				...
				array(	"name" => "Homepage Entries",
						"desc" => "Select the number of boxes that should appear below the Featured Entries",
