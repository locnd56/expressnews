...
?>
	...
	<div class="featured" id="post-<?php the_ID(); ?>"> 
		...
		<?php if ( get_post_meta($post->ID, 'featured', true) ) { ?> <!-- DISPLAYS THE IMAGE URL SPECIFIED IN THE CUSTOM FIELD -->
			
			<div class="featured-img" style="background:url(<?php echo get_post_meta($post->ID, "featured", $single = true); ?>) top left no-repeat;">
