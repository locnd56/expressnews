...
?>
		...
		<h3>
        	<span class="subscribe" style="float:none;">
        		<img src="<?php echo bloginfo('template_directory')."/images/rss-trans.png"; ?>" height="16" width="16" alt=""/>&nbsp;<a href="<?php if ( get_option('woo_feedburner_url') <> "" ) { echo get_option('woo_feedburner_url'); } else { echo get_bloginfo_rss('rss2_url'); } ?>" alt="Subscribe"><?php echo $title; ?></a>
            </span>
        </h3>		
...
register_widget_control('Subscribe', 'subscribeWidgetAdmin', 400, 200);
...
register_widget_control('Testimonial', 'testimonialwidgetAdmin', 400, 200);
