		...
		<div id="centercol">
            ...
            <div class="content">
                ...
                <div id="post-<?php the_ID(); ?>" class="box post">
                    ...
                    <div class="pic">
                        <a title="Permanent Link to <?php the_title(); ?>" href="<?php the_permalink() ?>"><img src="<?php echo bloginfo('template_url'); ?>/thumb.php?src=<?php echo get_post_meta($post->ID, "image", $single = true); ?>&amp;h=<?php if ( get_option('woo_thumb_height') <> "" ) { echo get_option('woo_thumb_height'); } else { ?>150<?php } ?>&amp;w=<?php if ( get_option('woo_thumb_width') <> "" ) { echo get_option('woo_thumb_width'); } else { ?>440<?php } ?>&amp;zc=1&amp;q=95" alt="<?php the_title(); ?>" /></a>       
                    </div>   	
