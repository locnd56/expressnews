...
<?php if ($comments) : ?>
	<h3 class="commh3" id="comments-count"><?php comments_number('No Responses', '1 Response', '% Responses' );?></h3>
	...
	<?php foreach ($comments as $comment) : ?>
       ...
       <li class="<?php echo $oddcomment; ?> <?php if(function_exists("author_highlight")) author_highlight(); ?>" id="comment-<?php comment_ID() ?>">
           ...
           <div class="comment-author">
                ...
                <p class="comment-meta"><span class="comment-author"><strong><?php comment_author_link() ?></strong></span></p>
                <p class="comment-meta"><span class="comment-author"><small><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('F jS, Y') ?></a></small></span></p>	
                <p class="comment-meta"><span class="comment-author"><small><?php edit_comment_link('Edit',' | ',''); ?></small></span></p>	
