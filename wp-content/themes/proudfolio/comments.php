...
<?php if ($comments) : ?>
	...
	<?php foreach ($bm_comments as $comment) : ?>
		...
		<li class="comment <?php echo $oddcomment; ?> <?php if(function_exists("author_highlight")) author_highlight(); ?>" id="comment-<?php comment_ID() ?>">
         ...
         ?>
			...
			<p class="commentmetadata"><?php comment_date('F jS, Y') ?>, <?php comment_time() ?> <a href="#comment-<?php comment_ID() ?>" title="Permalink to this comment">#</a></p>
